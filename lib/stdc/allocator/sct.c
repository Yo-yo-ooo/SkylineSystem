...
uint64_t SizeClassTable[59][3] = {
    ...
    { 32ULL,          0,        MB(2)  }, // 32B:  产生 65536 槽位，SCB位图需扩容处理或分批管理
    { 64ULL,          0,        MB(2)  }, // 64B:  产生 32768 槽位 (bit_tail = 32767)
    { 128ULL,         0,        MB(1)  }, // 128B: 产生 8192 槽位
    { 256ULL,         0,        MB(1)  }, // 256B: 产生 4096 槽位
    { 512ULL,         0,        KB(512)}, // 512B: 产生 1024 槽位
