...
//
// This file provides a highly optimized version of memset_fpx86.
//
...
void * memset_128bit_32B_u(void *dest, const __m128i_u val, size_t len)
{
  ...
  while (len--)
  {
    _mm_storeu_si128(ptr++, val); // 1
    _mm_storeu_si128(ptr++, val); // 2
  }
...
void * memset_128bit_64B_u(void *dest, const __m128i_u val, size_t len)
{
  ...
  while (len--)
  {
    _mm_storeu_si128(ptr++, val); // 1
    _mm_storeu_si128(ptr++, val); // 2
    _mm_storeu_si128(ptr++, val); // 3
    _mm_storeu_si128(ptr++, val); // 4
  }
...
void * memset_128bit_128B_u(void *dest, const __m128i_u val, size_t len)
{
  ...
  while (len--)
  {
    ...
    _mm_storeu_si128(ptr++, val); // 3
    _mm_storeu_si128(ptr++, val); // 4
    _mm_storeu_si128(ptr++, val); // 5
    _mm_storeu_si128(ptr++, val); // 6
    _mm_storeu_si128(ptr++, val); // 7
    _mm_storeu_si128(ptr++, val); // 8
  }
...
void * memset_128bit_256B_u(void *dest, const __m128i_u val, size_t len)
{
  ...
  while (len--)
  {
    ...
    _mm_storeu_si128(ptr++, val); // 7
    _mm_storeu_si128(ptr++, val); // 8
    _mm_storeu_si128(ptr++, val); // 9
    _mm_storeu_si128(ptr++, val); // 10
    _mm_storeu_si128(ptr++, val); // 11
    _mm_storeu_si128(ptr++, val); // 12
    _mm_storeu_si128(ptr++, val); // 13
    _mm_storeu_si128(ptr++, val); // 14
    _mm_storeu_si128(ptr++, val); // 15
    _mm_storeu_si128(ptr++, val); // 16
  }
...
void * memset_256bit_64B_u(void *dest, const __m256i_u val, size_t len)
{
  ...
  while (len--)
  {
    _mm256_storeu_si256(ptr++, val); // 1
    _mm256_storeu_si256(ptr++, val); // 2
  }
...
void * memset_256bit_128B_u(void *dest, const __m256i_u val, size_t len)
{
  ...
  while (len--)
  {
    _mm256_storeu_si256(ptr++, val); // 1
    _mm256_storeu_si256(ptr++, val); // 2
    _mm256_storeu_si256(ptr++, val); // 3
    _mm256_storeu_si256(ptr++, val); // 4
  }
...
void * memset_256bit_256B_u(void *dest, const __m256i_u val, size_t len)
{
  ...
  while (len--)
  {
    ...
    _mm256_storeu_si256(ptr++, val); // 3
    _mm256_storeu_si256(ptr++, val); // 4
    _mm256_storeu_si256(ptr++, val); // 5
    _mm256_storeu_si256(ptr++, val); // 6
    _mm256_storeu_si256(ptr++, val); // 7
    _mm256_storeu_si256(ptr++, val); // 8
  }
...
void * memset_256bit_512B_u(void *dest, const __m256i_u val, size_t len)
{
  ...
  while (len--)
  {
    ...
    _mm256_storeu_si256(ptr++, val); // 7
    _mm256_storeu_si256(ptr++, val); // 8
    _mm256_storeu_si256(ptr++, val); // 9
    _mm256_storeu_si256(ptr++, val); // 10
    _mm256_storeu_si256(ptr++, val); // 11
    _mm256_storeu_si256(ptr++, val); // 12
    _mm256_storeu_si256(ptr++, val); // 13
    _mm256_storeu_si256(ptr++, val); // 14
    _mm256_storeu_si256(ptr++, val); // 15
    _mm256_storeu_si256(ptr++, val); // 16
  }
...
void * memset_512bit_128B_u(void *dest, const __m512i_u val, size_t len)
{
  ...
  while (len--)
  {
    _mm512_storeu_si512(ptr++, val); // 1
    _mm512_storeu_si512(ptr++, val); // 2
  }
...
void * memset_512bit_256B_u(void *dest, const __m512i_u val, size_t len)
{
  ...
  while (len--)
  {
    _mm512_storeu_si512(ptr++, val); // 1
    _mm512_storeu_si512(ptr++, val); // 2
    _mm512_storeu_si512(ptr++, val); // 3
    _mm512_storeu_si512(ptr++, val); // 4
  }
...
void * memset_512bit_512B_u(void *dest, const __m512i_u val, size_t len)
{
  ...
  while (len--)
  {
    ...
    _mm512_storeu_si512(ptr++, val); // 3
    _mm512_storeu_si512(ptr++, val); // 4
    _mm512_storeu_si512(ptr++, val); // 5
    _mm512_storeu_si512(ptr++, val); // 6
    _mm512_storeu_si512(ptr++, val); // 7
    _mm512_storeu_si512(ptr++, val); // 8
  }
...
void * memset_512bit_1kB_u(void *dest, const __m512i_u val, size_t len)
{
  ...
  while (len--)
  {
    ...
    _mm512_storeu_si512(ptr++, val); // 7
    _mm512_storeu_si512(ptr++, val); // 8
    _mm512_storeu_si512(ptr++, val); // 9
    _mm512_storeu_si512(ptr++, val); // 10
    _mm512_storeu_si512(ptr++, val); // 11
    _mm512_storeu_si512(ptr++, val); // 12
    _mm512_storeu_si512(ptr++, val); // 13
    _mm512_storeu_si512(ptr++, val); // 14
    _mm512_storeu_si512(ptr++, val); // 15
    _mm512_storeu_si512(ptr++, val); // 16
  }
...
void * memset_512bit_2kB_u(void *dest, const __m512i_u val, size_t len)
{
  ...
  while (len--)
  {
    ...
    _mm512_storeu_si512(ptr++, val); // 15
    _mm512_storeu_si512(ptr++, val); // 16
    _mm512_storeu_si512(ptr++, val); // 17
    _mm512_storeu_si512(ptr++, val); // 18
    _mm512_storeu_si512(ptr++, val); // 19
    _mm512_storeu_si512(ptr++, val); // 20
    _mm512_storeu_si512(ptr++, val); // 21
    _mm512_storeu_si512(ptr++, val); // 22
    _mm512_storeu_si512(ptr++, val); // 23
    _mm512_storeu_si512(ptr++, val); // 24
    _mm512_storeu_si512(ptr++, val); // 25
    _mm512_storeu_si512(ptr++, val); // 26
    _mm512_storeu_si512(ptr++, val); // 27
    _mm512_storeu_si512(ptr++, val); // 28
    _mm512_storeu_si512(ptr++, val); // 29
    _mm512_storeu_si512(ptr++, val); // 30
    _mm512_storeu_si512(ptr++, val); // 31
    _mm512_storeu_si512(ptr++, val); // 32
  }
...
void * memset_256bit_as(void *dest, const __m256i val, size_t len)
{
  __m256i *ptr = (__m256i*)dest;
...
// 64 bytes
void * memset_256bit_64B_as(void *dest, const __m256i val, size_t len)
{
  __m256i *ptr = (__m256i*)dest;
...
// 128 bytes
void * memset_256bit_128B_as(void *dest, const __m256i val, size_t len)
{
  __m256i *ptr = (__m256i*)dest;
...
// 256 bytes
void * memset_256bit_256B_as(void *dest, const __m256i val, size_t len)
{
  __m256i *ptr = (__m256i*)dest;
...
// 512 bytes
void * memset_256bit_512B_as(void *dest, const __m256i val, size_t len)
{
  __m256i *ptr = (__m256i*)dest;
...
void * memset_512bit_as(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
// 128 bytes
void * memset_512bit_128B_as(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
// 256 bytes
void * memset_512bit_256B_as(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
// 512 bytes
void * memset_512bit_512B_as(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
// 1024 bytes, or 1 kB
void * memset_512bit_1kB_as(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
// 2048 bytes, or 2 kB
void * memset_512bit_2kB_as(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
// 4096 bytes, or 4 kB, also 1 page
void * memset_512bit_4kB_as(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
void * memset_large(void *dest, const uint8_t val, size_t numbytes)
{
  ...
  while(numbytes)
  // Each memset_fpx86 has its own loop.
  {
    if(numbytes < 16) // 1-15 bytes (the other scalars would need to be memset_fpx86 anyways)
    {
...
void * memset_large_4B(void *dest, const uint32_t val, size_t numbytes_div_4)
{
  ...
  // Each memset_fpx86 has its own loop.
  {
    if(numbytes_div_4 < 4) // 4, 8, 12 bytes (the other scalars would need to be memset_fpx86 anyways)
    {
...
// To set values of sizes > 1 byte, call the desired memset_fpx86 functions directly
...
void * AVX_memset_4B(void *dest, const uint32_t val, size_t numbytes_div_4)
{
  ...
  else
  {
    ...
    if(numbytes_div_4 > numbytes_to_align_div_4)
    {
      ...
      // Now this should be near the fastest possible since stores are aligned.
      // ...and in memset_fpx86 there are only stores.
