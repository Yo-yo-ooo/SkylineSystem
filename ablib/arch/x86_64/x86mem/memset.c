...
void *AVX_memsetV3(void *dest, const uint8_t val, size_t numbytes) {return dest;}
#else
__attribute__((weak))
...
__attribute__((weak, used))
void *AVX_memsetV2(void *dest, const uint8_t val, size_t numbytes) {return dest;}
#else
__attribute__((weak))
...
__attribute__((weak, used))
void *AVX_memsetV1(void *dest, const uint8_t val, size_t numbytes) {return dest;}
#else
__attribute__((weak))
